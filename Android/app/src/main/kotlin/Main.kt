...
internal val logger: SkipLogger = SkipLogger(subsystem = "sktip.test", category = "SktipTest")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SktipTestAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        SktipTestAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        SktipTestAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        SktipTestAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        SktipTestAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SktipTestAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SktipTestRootView().Compose(context = contentContext)
        }
    }
}
